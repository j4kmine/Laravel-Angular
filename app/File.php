...
class File extends Model
{
	 ...
	 public function uploadimagesmode(Request $request){
        ...
        return [
            'file' => $fileImg,
            'file_id' => $file->id,
            'thumbUrl' => env('APP_URL') . "gallery_{$galleryId}/thumb/" . $filename,
            'url' => env('APP_URL') . "gallery_{$galleryId}/medium/" . $filename,
            'main' => env('APP_URL') . "gallery_{$galleryId}/main/" . $filename,
        ];
	 }
}
